    ...
    <form action="login" method="post">
        <table  align="center" width="300px" height="200px">
            ...
            <tr><td width="150px" align="center" >密码</td>
                <td><input type="password" name="password" placeholder="请输入注册密码" id="input1"></td>
            </tr>
            <tr><td width="150px" align="center"  >再次输入</td>
                <td><input type="password" name="conpassword" placeholder="确认密码" id="input1"></td>
            </tr>
            <tr><td width="150px" align="center"  >性别</td>
                <td><input type="text" name="conpassword" placeholder="输入性别" id="input1"></td>
            </tr>
            <tr><td width="150px" align="center"  >联系电话</td>
                <td><input type="text" name="phone" placeholder="输入联系电话" id="input1"></td>
            </tr>
            <tr><td width="150px" align="center"  >收货地址</td>
                <td><input type="text" name="address" placeholder="输入地址" id="input1"></td>
            </tr>
